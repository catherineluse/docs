...
1. Click **API & Keys.** 
1. To see the API view, copy the **Endpoint** and paste it into a web browser. You should be able to see the Rancher server's top-level resources.


as well as create [API keys]({{<baseurl>}}/rancher/v2.x/en/user-settings/api-keys/).
