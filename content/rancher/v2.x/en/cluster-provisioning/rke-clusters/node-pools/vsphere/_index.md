...
By using Rancher with vSphere, you can bring cloud operations on-premesis.
...
One of the biggest advantages of provisioning vSphere nodes with Rancher is that it allows you to take advantage of Rancher's self-healing node pools, also called the [node auto-replace feature.]({{<baseurl>}}/rancher/v2.x/en/cluster-provisioning/rke-clusters/node-pools/#node-auto-replace) When Rancher provisions nodes from a node template, Rancher can automatically replace unreachable nodes.

# Node Templates Dynamically Populate vSphere Options for Instances and Scheduling
...
# Operating Systems for Rancher-provisioned Nodes in vSphere
